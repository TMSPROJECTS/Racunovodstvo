<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Komitenti_poslovniPartneri_TR_Dodavanje.aspx.cs" Inherits="pages_Komitenti_poslovniPartneri_TR_Dodavanje" %>
    ...
    <form id="form2" runat="server">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a runat ="server" id="linkPoslovni" class = "pages" href="#" page_name="Komitenti_poslovniPartneri.aspx">Poslovni partneri</a></li>
          <li class="breadcrumb-item"><a id="A1" class = "pages" href="#" page_name="Komitenti_poslovniPartneri_TR.aspx?SIFRA=<%Response.Write(Request.QueryString["SIFRA"]);%>">Tekući računi</a></li>
        <li class="breadcrumb-item active">Unos</li>
          ...
          <div class="row">
              <div class="labela col-md-4">
                 <label for="lblRacun">* Račun</label>
              </div>
              <div class = "inputDiv col-md-8">
	              <div class="col-md-4">
	             	 <input class="form-control" runat ="server" id="inputRacun" name="inputRacun"  required>
	             </div>
	          </div>
          </div>
              ...
              <div class = "inputDiv col-md-8">
	              <div class="saveButton">
                     ...
                     <!--  <a runat="server" onclick ="btnSave_Click" class="btn btn-primary btn-xl js-scroll-trigger pages" href="#" page_name="Komitenti_poslovniPartneri.aspx">Sačuvaj</a>-->
	             	 ...
	             	 <a class="btn btn-unos btn-xl js-scroll-trigger pages" href="#" page_name="Komitenti_poslovniPartneri_TR.aspx?SIFRA=<%Response.Write(Request.QueryString["SIFRA"]);%>">Odustani</a>
        ...
        <script src="../js/TekuciRacuni.js"></script>
