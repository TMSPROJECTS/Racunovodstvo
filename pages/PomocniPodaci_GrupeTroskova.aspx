<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PomocniPodaci_GrupeTroskova.aspx.cs" Inherits="pages_PomocniPodaci_GrupeTroskova" %>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    <form id="form2" runat="server">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Grupe troškova</li>
      </ol>
      <div class="card mb-3">
       <div class="card-header">
          <i class="fa fa-table"></i> Grupe troškova</div>
          <div class ="row enterButton">
          <a class="btn btn-primary btn-xl js-scroll-trigger pages" href="#" page_name="PomocniPodaci_GrupeTroskova_Dodavanje.aspx">Novi unos</a>&nbsp;&nbsp;&nbsp;<span ID="spObavestenje" style="color:cadetblue; font-weight: bold; font-size: 18px;">
              <% 
              ...
              <tbody>
                <%
                    ...
                    foreach (System.Data.DataRow red in dtSviPodaci.Rows)
                    {
                        ...
                        Response.Write("<td> <a class =pages href=# page_name=PomocniPodaci_GrupeTroskova_Dodavanje.aspx?SIFRA9=" + red["Sifra"].ToString() + " >" + red["Sifra"].ToString() + "</a></td>");
