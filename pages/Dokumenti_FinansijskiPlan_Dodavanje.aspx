<%@ Page  EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeFile="Dokumenti_FinansijskiPlan_Dodavanje.aspx.cs" Inherits="pages_Dokumenti_FinansijskiPlan_Dodavanje" %>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    <form id="form2" runat="server">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a runat ="server" id="A1" class = "pages" href="#" page_name="Dokumenti_FinansijskiPlan.aspx">Finansijski plan</a></li>
        ...
        <form action = "">
            ...
            <div class="row">
              <div class="labela col-md-4">
                 <label for="datumGodina">* Godina</label>
              </div>
              <div class = "inputDiv col-md-8">
	              <div class="col-md-4">
	             	 <input runat ="server" type="text" class="form-control" id="godina" name="godina" required>
	             </div>
	          </div>
          </div>
        ...
        <script src="../js/FinansijskiPlan_Dodavanje.js"></script>
