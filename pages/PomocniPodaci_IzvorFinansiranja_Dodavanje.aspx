<%@ Page  EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeFile="PomocniPodaci_IzvorFinansiranja_Dodavanje.aspx.cs" Inherits="pages_PomocniPodaci_IzvorFinansiranja_Dodavanje" %>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    <form id="form1" runat="server">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a class = "pages" href="#" page_name="PomocniPodaci_IzvorFinansiranja.aspx">Izvor finansiranja</a></li>
              ...
              <div class = "inputDiv col-md-8">
	              <div class="saveButton">
	             	...
	             	<!-- <input type="button" onclick="" class="btn btn-unos btn-xl js-scroll-trigger pages" value ="Brisanje"> -->
	             	 ...
	             	 <a class="btn btn-unos btn-xl js-scroll-trigger pages" href="#" page_name="PomocniPodaci_IzvorFinansiranja.aspx">Odustani</a>
	             </div>
	          </div>
          </div>
        ...
        <script src="../js/IzvorFinansiranja_Dodavanje.js"></script>
