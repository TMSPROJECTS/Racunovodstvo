function btnSave() {
    ...
    var dataValue = "{prodokument: '" + dok + "', proNaziv: '" + document.getElementById("inputNaziv").value + "'}";

    $.ajax({
        type: "POST",
        url: "PomocniPodaci_GrupeTroskova_Dodavanje.aspx/sacuvaj",
        ...
        success: function (result) {
            if (result.d[0] == "N") {
                ...
                $('#main').load('PomocniPodaci_GrupeTroskova.aspx?spObavestenje=' + encodeURIComponent(result.d[1]));
            }
        }
    });
}