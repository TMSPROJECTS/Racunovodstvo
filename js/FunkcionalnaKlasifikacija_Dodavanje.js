function btnSave() {
    ...
    $.ajax({
        type: "POST",
        url: "PomocniPodaci_FunkcionalnaKlasifikacija_Dodavanje.aspx/sacuvaj",
        ...
        success: function (result) {
            if (result.d[0] == "N") {
                ...
                $('#main').load('PomocniPodaci_FunkcionalnaKlasifikacija.aspx?spObavestenje=' + encodeURIComponent(result.d[1]));
            }
        }
    });
}